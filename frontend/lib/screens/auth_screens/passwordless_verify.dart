...
class PasswordlessVerifyScreen extends StatefulWidget {

  const PasswordlessVerifyScreen({required this.email, super.key});
  final String email;

  @override
  State<PasswordlessVerifyScreen> createState() =>
      _PasswordlessVerifyScreenState();
}

class _PasswordlessVerifyScreenState extends State<PasswordlessVerifyScreen> {
                ...
                Column(
                  ...
                  children: [
                    ...
                    RichText(
                      ...
                      text: TextSpan(
                        text: 'We sent a passwordless verification code to\n',
                    ...
                    Obx(
                      () => isShowingTimer.value
                          ...
                          : isLoading.value
                              ...
                              : Opacity(
                                  opacity: isShowingTimer.value ? 0.5 : 1,
                                  child: CustomTextButton(
                                    text: 'Resend',
                                    color: Colors.blue,
                                    onPressed: isShowingTimer.value
                                        ? () {}
                                        : () async {
